...
type jpeg_decompress_struct
	...
	buffered_image as boolean_
	raw_data_out as boolean_
	dct_method as J_DCT_METHOD
	do_fancy_upsampling as boolean_
	do_block_smoothing as boolean_
	quantize_colors as boolean_
	dither_mode as J_DITHER_MODE
	two_pass_quantize as boolean_
	desired_number_of_colors as integer
	enable_1pass_quant as boolean_
	enable_external_quant as boolean_
	enable_2pass_quant as boolean_
	...
	arith_ac_K(0 to 16-1) as UINT8
	restart_interval as uinteger
	saw_JFIF_marker as boolean_
	JFIF_major_version as UINT8
	JFIF_minor_version as UINT8
	density_unit as UINT8
	X_density as UINT16
	Y_density as UINT16
	saw_Adobe_marker as boolean_
...
type jpeg_destination_mgr
	...
	empty_output_buffer as function cdecl(byval as j_compress_ptr) as boolean_
...
type jpeg_source_mgr
	...
	fill_input_buffer as function cdecl(byval as j_decompress_ptr) as boolean_
	skip_input_data as sub cdecl(byval as j_decompress_ptr, byval as integer)
	resync_to_restart as function cdecl(byval as j_decompress_ptr, byval as integer) as boolean_
...
type jpeg_memory_mgr
	...
	request_virt_sarray as function cdecl(byval as j_common_ptr, byval as integer, byval as boolean_, byval as JDIMENSION, byval as JDIMENSION, byval as JDIMENSION) as jvirt_sarray_ptr
	request_virt_barray as function cdecl(byval as j_common_ptr, byval as integer, byval as boolean_, byval as JDIMENSION, byval as JDIMENSION, byval as JDIMENSION) as jvirt_barray_ptr
	realize_virt_arrays as sub cdecl(byval as j_common_ptr)
	access_virt_sarray as function cdecl(byval as j_common_ptr, byval as jvirt_sarray_ptr, byval as JDIMENSION, byval as JDIMENSION, byval as boolean_) as JSAMPARRAY
	access_virt_barray as function cdecl(byval as j_common_ptr, byval as jvirt_barray_ptr, byval as JDIMENSION, byval as JDIMENSION, byval as boolean_) as JBLOCKARRAY
...
type jpeg_marker_parser_method as function cdecl(byval as j_decompress_ptr) as boolean_
...
declare sub jpeg_set_quality (byval cinfo as j_compress_ptr, byval quality as integer, byval force_baseline as boolean_)
declare sub jpeg_set_linear_quality (byval cinfo as j_compress_ptr, byval scale_factor as integer, byval force_baseline as boolean_)
declare sub jpeg_add_quant_table (byval cinfo as j_compress_ptr, byval which_tbl as integer, byval basic_table as uinteger ptr, byval scale_factor as integer, byval force_baseline as boolean_)
...
declare sub jpeg_suppress_tables (byval cinfo as j_compress_ptr, byval suppress as boolean_)
...
declare sub jpeg_start_compress (byval cinfo as j_compress_ptr, byval write_all_tables as boolean_)
...
declare function jpeg_read_header (byval cinfo as j_decompress_ptr, byval require_image as boolean_) as integer
declare function jpeg_start_decompress (byval cinfo as j_decompress_ptr) as boolean_
...
declare function jpeg_finish_decompress (byval cinfo as j_decompress_ptr) as boolean_
...
declare function jpeg_has_multiple_scans (byval cinfo as j_decompress_ptr) as boolean_
declare function jpeg_start_output (byval cinfo as j_decompress_ptr, byval scan_number as integer) as boolean_
declare function jpeg_finish_output (byval cinfo as j_decompress_ptr) as boolean_
declare function jpeg_input_complete (byval cinfo as j_decompress_ptr) as boolean_
...
declare function jpeg_resync_to_restart (byval cinfo as j_decompress_ptr, byval desired as integer) as boolean_
end extern
