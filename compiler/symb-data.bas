...
#include once "fbint.bi"
	...
	{ _
        ...
        (FB_DATACLASS_INTEGER, 16           	, 8*16          	, FALSE, FB_DATATYPE_XMMWORD, @"xmmword"	), _
		(FB_DATACLASS_INTEGER, FB_INTEGERSIZE	, 8*FB_INTEGERSIZE	, FALSE, FB_DATATYPE_UINT	, @"iterator"	)  _
	}
